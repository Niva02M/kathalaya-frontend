  ...
  return (
    <main className='min-h-screen bg-gradient-to-b from-gray-900 to-black flex items-center justify-center px-4'>
      <div className='max-w-md w-full bg-black/20 backdrop-blur-3xl rounded-xl p-8 shadow-lg text-gray-100'>
        <h1 className='text-3xl font-bold mb-6 text-yellow-400 text-center'>Create Account</h1>

        <form onSubmit={handleSubmit} className='space-y-6'>
          {error && <div className='bg-red-700 text-red-200 px-4 py-2 rounded'>{error}</div>}
